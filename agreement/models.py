...
class LegalAgreement(models.Model):
    ...
    access_token = models.UUIDField(default=uuid.uuid4, editable=False, unique=True)  # Add access token field
    ...
    first_party_signature = models.FileField(upload_to='signatures/', null=True, blank=True)  
    ...
    second_party_signature = models.FileField(upload_to='signatures/', null=True, blank=True)
